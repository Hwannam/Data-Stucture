...
public: 
    ...
    void ReplaceItemMember(ItemType oldItem, ItemType newItem);
private:
...
template <class ItemType>
void QueType<ItemType>:: ReplaceItemMember(ItemType oldItem, ItemType newItem)
{
    NodeType<ItemType>* ptr = front;
    while (ptr != NULL)
    {
        if (ptr->info == oldItem)
            ptr->info = newItem;
