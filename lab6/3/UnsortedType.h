...
public:
  ...
  void MergeListsUnMember(UnsortedType<ItemType>& other, UnsortedType<ItemType>& result);
private:
...
template<class ItemType>
void UnsortedType<ItemType>::MergeListsUnMember(UnsortedType<ItemType>& other, UnsortedType<ItemType>& result)
{
    ItemType item; 
