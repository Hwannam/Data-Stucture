...
public:
	...
	void MergeListsSoMember(SortedType<ItemType>& other, SortedType<ItemType>& result);
...
template<class ItemType>
void SortedType<ItemType>::MergeListsSoMember(SortedType<ItemType>& other, SortedType<ItemType>& result)
{
	ItemType item;
