...
private:
  NodeType_u<ItemType>* listData;
  int length;
  NodeType_u<ItemType>* currentPos;
};
...
{
  NodeType_u<ItemType>* location;
  try
  {
    location = new NodeType_u<ItemType>;
    delete location;
    return false;
  }
...
{
    NodeType_u<ItemType>* location = listData;
    NodeType_u<ItemType>* tempLocation;
