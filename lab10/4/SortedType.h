...
private:
  NodeType_s<ItemType>* listData;
  int length;
  NodeType_s<ItemType>* currentPos;
};
template<class ItemType>
struct NodeType_s
{
...
{
  NodeType_s<ItemType>* location;
  try
  {
    location = new NodeType_s<ItemType>;
    delete location;
    return false;
  }
...
{
  NodeType_s<ItemType>* newNode;  // pointer to node being inserted
  NodeType_s<ItemType>* predLoc;  // trailing pointer
  NodeType_s<ItemType>* location; // traveling pointer
  bool moreToSearch;
  ...
  newNode = new NodeType_s<ItemType>;
  newNode->info = item;
...
{
    NodeType_s<ItemType>* location = listData;
    NodeType_s<ItemType>* tempLocation;
